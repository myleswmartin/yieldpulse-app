import svgPaths from "./svg-07pr5sck10";
  ...
  return (
    <div className="bg-white content-stretch flex flex-col items-center justify-center p-[8px] relative rounded-[4px] shrink-0 size-[20px]">
      <div className="flex flex-col font-['Inter:Semi_Bold',sans-serif] font-semibold h-[14px] justify-center leading-[0] not-italic relative shrink-0 text-[#0a1461] text-[8px] text-center tracking-[-0.16px] w-[11px]">
        <p className="leading-[22px] whitespace-pre-wrap">05</p>
      </div>
    </div>
  );
}
    ...
    <div className="bg-[#1f2975] relative rounded-[5px] shrink-0 w-full">
      ...
      <div className="flex flex-row items-center size-full">
        <div className="content-stretch flex gap-[8px] items-center pl-[6px] pr-[8px] py-[6px] relative w-full">
          <Frame22 />
          <p className="font-['Inter:Bold',sans-serif] font-bold leading-[16px] not-italic relative shrink-0 text-[12px] text-white w-[352px] whitespace-pre-wrap">Five Year Investment Outcome</p>
        </div>
      </div>
    </div>
  );
    ...
    <div className="relative shrink-0 w-full" data-name="Frame">
      ...
      <div className="flex flex-row items-center justify-center size-full">
        <div className="content-stretch flex font-['Inter:Regular',sans-serif] font-normal gap-[8px] items-center justify-center leading-[20px] not-italic pb-[2px] px-[8px] relative text-[#0e172b] text-[8px] tracking-[-0.16px] w-full whitespace-pre-wrap">
          <p className="flex-[1_0_0] min-h-px min-w-px relative">Final Property Value</p>
          <p className="relative shrink-0 text-right w-[142px]">AED 1,324,897</p>
        </div>
      </div>
    </div>
  );
...
function Frame2() {
  return (
    <div className="relative shrink-0 w-full" data-name="Frame">
      ...
      <div className="flex flex-row items-center justify-center size-full">
        <div className="content-stretch flex font-['Inter:Regular',sans-serif] font-normal gap-[8px] items-center justify-center leading-[20px] not-italic pb-[2px] px-[8px] relative text-[#0e172b] text-[8px] tracking-[-0.16px] w-full whitespace-pre-wrap">
          <p className="flex-[1_0_0] min-h-px min-w-px relative">Remaining Loan Balance</p>
          <p className="relative shrink-0 text-right w-[142px]">AED 744,074</p>
        </div>
      </div>
    </div>
  );
...
function Frame3() {
  return (
    <div className="relative shrink-0 w-full" data-name="Frame">
      ...
      <div className="flex flex-row items-center justify-center size-full">
        <div className="content-stretch flex font-['Inter:Regular',sans-serif] font-normal gap-[8px] items-center justify-center leading-[20px] not-italic pb-[2px] px-[8px] relative text-[#0e172b] text-[8px] tracking-[-0.16px] w-full whitespace-pre-wrap">
          <p className="flex-[1_0_0] min-h-px min-w-px relative">Your Equity</p>
          <p className="relative shrink-0 text-right w-[142px]">AED 580,823</p>
        </div>
      </div>
    </div>
  );
...
function Frame4() {
  return (
    <div className="relative shrink-0 w-full" data-name="Frame">
      ...
      <div className="flex flex-row items-center justify-center size-full">
        <div className="content-stretch flex font-['Inter:Regular',sans-serif] font-normal gap-[8px] items-center justify-center leading-[20px] not-italic pb-[2px] px-[8px] relative text-[#0e172b] text-[8px] tracking-[-0.16px] w-full whitespace-pre-wrap">
          <p className="flex-[1_0_0] min-h-px min-w-px relative">Cumulative Cash Flow</p>
          <p className="relative shrink-0 text-right w-[142px]">AED 62,791</p>
        </div>
      </div>
    </div>
  );
...
function Frame5() {
  return (
    <div className="relative shrink-0 w-full" data-name="Frame">
      ...
      <div className="flex flex-row items-center justify-center size-full">
        <div className="content-stretch flex font-['Inter:Regular',sans-serif] font-normal gap-[8px] items-center justify-center leading-[20px] not-italic pb-[2px] px-[8px] relative text-[#0e172b] text-[8px] tracking-[-0.16px] w-full whitespace-pre-wrap">
          <p className="flex-[1_0_0] min-h-px min-w-px relative">Less: Selling Fee (2%)</p>
          <p className="relative shrink-0 text-right w-[142px]">(AED 26,498)</p>
        </div>
      </div>
    </div>
  );
...
function Frame6() {
  return (
    <div className="relative shrink-0 w-full" data-name="Frame">
      ...
      <div className="flex flex-row items-center justify-center size-full">
        <div className="content-stretch flex font-['Inter:Regular',sans-serif] font-normal gap-[8px] items-center justify-center leading-[20px] not-italic pb-[2px] px-[8px] relative text-[#0e172b] text-[8px] tracking-[-0.16px] w-full whitespace-pre-wrap">
          <p className="flex-[1_0_0] min-h-px min-w-px relative">Net Sale Proceeds</p>
          <p className="relative shrink-0 text-right w-[142px]">AED 554,325</p>
        </div>
      </div>
    </div>
  );
    ...
    <div className="relative shrink-0 w-full" data-name="Frame">
      <div className="flex flex-row items-center justify-center size-full">
        <div className="content-stretch flex font-['Inter:Semi_Bold',sans-serif] font-semibold gap-[8px] items-center justify-center leading-[20px] not-italic px-[8px] relative text-[#1e2875] text-[8px] w-full whitespace-pre-wrap">
          <p className="flex-[1_0_0] min-h-px min-w-px relative">Total Return</p>
          <p className="relative shrink-0 text-right w-[136px]">AED 180,116</p>
        </div>
      </div>
    </div>
  );
...
function Frame9() {
  return (
    <div className="relative shrink-0 w-full" data-name="Frame">
      <div className="flex flex-row items-center justify-center size-full">
        <div className="content-stretch flex font-['Inter:Semi_Bold',sans-serif] font-semibold gap-[8px] items-center justify-center leading-[20px] not-italic px-[8px] relative text-[#1e2875] text-[8px] w-full whitespace-pre-wrap">
          <p className="flex-[1_0_0] min-h-px min-w-px relative">Return on Investment (ROI)</p>
          <p className="relative shrink-0 text-right w-[136px]">41.2%</p>
        </div>
      </div>
    </div>
  );
...
function Frame25() {
  return (
    <div className="content-stretch flex flex-col gap-[12px] items-start relative shrink-0 w-full">
      <p className="font-['Inter:Regular',sans-serif] font-normal leading-[20px] not-italic opacity-50 relative shrink-0 text-[#0e172b] text-[10px] tracking-[-0.2px]">Assuming 2.00% annual appreciation and 2.00% rent growth:</p>
      <Table />
    </div>
  );
}
