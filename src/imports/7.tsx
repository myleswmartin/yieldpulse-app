import svgPaths from "./svg-0caz9fcofg";
    ...
    <div className="relative shrink-0 w-full" data-name="Frame">
      ...
      <div className="flex flex-row items-center justify-center size-full">
        <div className="content-stretch flex font-['Inter:Semi_Bold',sans-serif] font-semibold gap-[8px] items-center justify-center leading-[20px] not-italic pb-[2px] px-[8px] relative text-[#1e2875] text-[10px] w-full">
          <p className="flex-[1_0_0] min-h-px min-w-px relative whitespace-pre-wrap">Vacancy Rate</p>
    ...
    <div className="relative shrink-0 w-full" data-name="Frame">
      ...
      <div className="flex flex-row items-center justify-center size-full">
        <div className="content-stretch flex font-['Inter:Regular',sans-serif] font-normal gap-[8px] items-center justify-center leading-[20px] not-italic pb-[2px] px-[8px] relative text-[#0e172b] text-[8px] tracking-[-0.16px] w-full whitespace-pre-wrap">
          <p className="flex-[1_0_0] min-h-px min-w-px relative">0.00%</p>
          <p className="relative shrink-0 text-right w-[80px]">AED 12,773</p>
          <p className="relative shrink-0 text-right w-[80px]">2.92%</p>
        </div>
      </div>
    </div>
  );
...
function Frame3() {
  return (
    <div className="relative shrink-0 w-full" data-name="Frame">
      ...
      <div className="flex flex-row items-center justify-center size-full">
        <div className="content-stretch flex font-['Inter:Regular',sans-serif] font-normal gap-[8px] items-center justify-center leading-[20px] not-italic pb-[2px] px-[8px] relative text-[#0e172b] text-[8px] tracking-[-0.16px] w-full whitespace-pre-wrap">
          <p className="flex-[1_0_0] min-h-px min-w-px relative">10.0%</p>
          <p className="relative shrink-0 text-right w-[80px]">AED 3,173</p>
          <p className="relative shrink-0 text-right w-[80px]">0.73%</p>
        </div>
      </div>
    </div>
  );
...
function Frame4() {
  return (
    <div className="relative shrink-0 w-full" data-name="Frame">
      ...
      <div className="flex flex-row items-center justify-center size-full">
        <div className="content-stretch flex font-['Inter:Regular',sans-serif] font-normal gap-[8px] items-center justify-center leading-[20px] not-italic pb-[2px] px-[8px] relative text-[#0e172b] text-[8px] tracking-[-0.16px] w-full whitespace-pre-wrap">
          <p className="flex-[1_0_0] min-h-px min-w-px relative">15.0%</p>
          <p className="relative shrink-0 text-right w-[80px]">(AED 1,627)</p>
          <p className="relative shrink-0 text-right w-[80px]">-0.37%</p>
        </div>
      </div>
    </div>
  );
...
function Frame5() {
  return (
    <div className="relative shrink-0 w-full" data-name="Frame">
      <div className="flex flex-row items-center justify-center size-full">
        <div className="content-stretch flex font-['Inter:Regular',sans-serif] font-normal gap-[8px] items-center justify-center leading-[20px] not-italic pb-[2px] px-[8px] relative text-[#0e172b] text-[8px] tracking-[-0.16px] w-full whitespace-pre-wrap">
          <p className="flex-[1_0_0] min-h-px min-w-px relative">20.0%</p>
          <p className="relative shrink-0 text-right w-[80px]">(AED 6,427)</p>
          <p className="relative shrink-0 text-right w-[80px]">-1.47%</p>
        </div>
      </div>
    </div>
  );
...
function Frame21() {
  return (
    <div className="content-stretch flex flex-col gap-[8px] items-start relative shrink-0 w-full">
      <p className="font-['Inter:Semi_Bold',sans-serif] font-semibold leading-[16px] not-italic relative shrink-0 text-[#0a1461] text-[14px] tracking-[-0.28px] w-full whitespace-pre-wrap">Vacancy Rate Sensitivity</p>
      <Table />
    </div>
  );
}
    ...
    <div className="bg-[#f8fafc] relative rounded-[8px] shrink-0 w-full">
      <div className="flex flex-col justify-center overflow-clip rounded-[inherit] size-full">
        <div className="content-stretch flex flex-col gap-[2px] items-start justify-center not-italic px-[12px] py-[8px] relative w-full whitespace-pre-wrap">
          ...
          <p className="font-['Inter:Regular',sans-serif] font-normal leading-[14px] relative shrink-0 text-[8px] text-[rgba(14,23,43,0.5)] tracking-[-0.16px] w-full">Your analysis assumes 5.00% vacancy. Zero vacancy improves cash flow to AED 12,773. At 20% vacancy (worst case), cash flow falls to (AED 6,427), highlighting the importance of tenant retention.</p>
        </div>
      </div>
      <div aria-hidden="true" className="absolute border-[#eef0f2] border-[0.8px] border-solid inset-0 pointer-events-none rounded-[8px]" />
    </div>
