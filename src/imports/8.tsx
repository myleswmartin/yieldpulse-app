import svgPaths from "./svg-lp3abpco2q";
  ...
  return (
    <div className="relative shrink-0 w-full" data-name="Frame">
      ...
      <div className="flex flex-row items-center justify-center size-full">
        <div className="content-stretch flex font-['Inter:Semi_Bold',sans-serif] font-semibold gap-[8px] items-center justify-center leading-[20px] not-italic pb-[2px] px-[8px] relative text-[#1e2875] text-[10px] w-full">
          <p className="flex-[1_0_0] min-h-px min-w-px relative whitespace-pre-wrap">Interest Rate</p>
          <p className="relative shrink-0 text-right">Annual Cash Flow</p>
          <p className="relative shrink-0 text-right w-[80px] whitespace-pre-wrap">CoC Return</p>
        </div>
      </div>
    </div>
  );
    ...
    <div className="relative shrink-0 w-full" data-name="Frame">
      ...
      <div className="flex flex-row items-center justify-center size-full">
        <div className="content-stretch flex font-['Inter:Regular',sans-serif] font-normal gap-[8px] items-center justify-center leading-[20px] not-italic pb-[2px] px-[8px] relative text-[#0e172b] text-[8px] tracking-[-0.16px] w-full whitespace-pre-wrap">
          <p className="flex-[1_0_0] min-h-px min-w-px relative">3.00%</p>
          <p className="relative shrink-0 text-right w-[80px]">AED 19,099</p>
          <p className="relative shrink-0 text-right w-[80px]">4.37%</p>
        </div>
      </div>
    </div>
  );
...
function Frame2() {
  return (
    <div className="relative shrink-0 w-full" data-name="Frame">
      ...
      <div className="flex flex-row items-center justify-center size-full">
        <div className="content-stretch flex font-['Inter:Regular',sans-serif] font-normal gap-[8px] items-center justify-center leading-[20px] not-italic pb-[2px] px-[8px] relative text-[#0e172b] text-[8px] tracking-[-0.16px] w-full whitespace-pre-wrap">
          <p className="flex-[1_0_0] min-h-px min-w-px relative">4.00%</p>
          <p className="relative shrink-0 text-right w-[80px]">AED 13,694</p>
          <p className="relative shrink-0 text-right w-[80px]">3.13%</p>
        </div>
      </div>
    </div>
  );
...
function Frame3() {
  return (
    <div className="relative shrink-0 w-full" data-name="Frame">
      ...
      <div className="flex flex-row items-center justify-center size-full">
        <div className="content-stretch flex font-['Inter:Regular',sans-serif] font-normal gap-[8px] items-center justify-center leading-[20px] not-italic pb-[2px] px-[8px] relative text-[#0e172b] text-[8px] tracking-[-0.16px] w-full whitespace-pre-wrap">
          <p className="flex-[1_0_0] min-h-px min-w-px relative">5.00%</p>
          <p className="relative shrink-0 text-right w-[80px]">AED 7,973</p>
          <p className="relative shrink-0 text-right w-[80px]">1.82%</p>
        </div>
      </div>
    </div>
  );
...
function Frame4() {
  return (
    <div className="relative shrink-0 w-full" data-name="Frame">
      ...
      <div className="flex flex-row items-center justify-center size-full">
        <div className="content-stretch flex font-['Inter:Regular',sans-serif] font-normal gap-[8px] items-center justify-center leading-[20px] not-italic pb-[2px] px-[8px] relative text-[#0e172b] text-[8px] tracking-[-0.16px] w-full whitespace-pre-wrap">
          <p className="flex-[1_0_0] min-h-px min-w-px relative">6.00%</p>
          <p className="relative shrink-0 text-right w-[80px]">AED 1,954</p>
          <p className="relative shrink-0 text-right w-[80px]">0.45%</p>
        </div>
      </div>
    </div>
  );
...
function Frame5() {
  return (
    <div className="relative shrink-0 w-full" data-name="Frame">
      <div className="flex flex-row items-center justify-center size-full">
        <div className="content-stretch flex font-['Inter:Regular',sans-serif] font-normal gap-[8px] items-center justify-center leading-[20px] not-italic pb-[2px] px-[8px] relative text-[#0e172b] text-[8px] tracking-[-0.16px] w-full whitespace-pre-wrap">
          <p className="flex-[1_0_0] min-h-px min-w-px relative">7.00%</p>
          <p className="relative shrink-0 text-right w-[80px]">(AED 4,343)</p>
          <p className="relative shrink-0 text-right w-[80px]">-0.99%</p>
        </div>
      </div>
    </div>
  );
...
function Frame21() {
  return (
    <div className="content-stretch flex flex-col gap-[8px] items-start relative shrink-0 w-full">
      <p className="font-['Inter:Semi_Bold',sans-serif] font-semibold leading-[16px] not-italic relative shrink-0 text-[#0a1461] text-[14px] tracking-[-0.28px] w-full whitespace-pre-wrap">Interest Rate Sensitivity</p>
      <Table />
    </div>
  );
}
    ...
    <div className="bg-[#f8fafc] relative rounded-[8px] shrink-0 w-full">
      <div className="flex flex-col justify-center overflow-clip rounded-[inherit] size-full">
        <div className="content-stretch flex flex-col gap-[2px] items-start justify-center not-italic px-[12px] py-[8px] relative w-full whitespace-pre-wrap">
          ...
          <p className="font-['Inter:Regular',sans-serif] font-normal leading-[14px] relative shrink-0 text-[8px] text-[rgba(14,23,43,0.5)] tracking-[-0.16px] w-full">Each 1% change in interest rate impacts annual cash flow by approximately AED 6,019. At 4.00%, cash flow is AED 13,694. At 6.00%, it falls to AED 1,954, demonstrating financing cost sensitivity.</p>
        </div>
      </div>
      <div aria-hidden="true" className="absolute border-[#eef0f2] border-[0.8px] border-solid inset-0 pointer-events-none rounded-[8px]" />
    </div>
