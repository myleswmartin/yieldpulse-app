import svgPaths from "./svg-zson8zmudx";
    ...
    <div className="relative shrink-0 w-full" data-name="Frame">
      ...
      <div className="flex flex-row items-center justify-center size-full">
        <div className="content-stretch flex font-['Inter:Semi_Bold',sans-serif] font-semibold gap-[8px] items-center justify-center leading-[20px] not-italic pb-[2px] px-[8px] relative text-[#1e2875] text-[10px] w-full whitespace-pre-wrap">
          <p className="flex-[1_0_0] min-h-px min-w-px relative">Assumption</p>
          <p className="relative shrink-0 text-right w-[100px]">Value</p>
          <p className="relative shrink-0 text-right w-[145px]">Basis</p>
        </div>
      </div>
    </div>
  );
    ...
    <div className="relative shrink-0 w-full" data-name="Frame">
      ...
      <div className="flex flex-row items-center justify-center size-full">
        <div className="content-stretch flex font-['Inter:Regular',sans-serif] font-normal gap-[8px] items-center justify-center leading-[20px] not-italic pb-[2px] px-[8px] relative text-[#0e172b] text-[8px] tracking-[-0.16px] w-full whitespace-pre-wrap">
          ...
          <p className="relative shrink-0 text-right w-[100px]">4% of purchase price</p>
          <p className="relative shrink-0 text-right w-[145px]">Dubai Land Department standard rate</p>
        </div>
      </div>
    </div>
  );
    ...
    <div className="relative shrink-0 w-full" data-name="Frame">
      ...
      <div className="flex flex-row items-center justify-center size-full">
        <div className="content-stretch flex font-['Inter:Regular',sans-serif] font-normal gap-[8px] items-center justify-center leading-[20px] not-italic pb-[2px] px-[8px] relative text-[#0e172b] text-[8px] tracking-[-0.16px] w-full whitespace-pre-wrap">
          ...
          <p className="relative shrink-0 text-right w-[100px]">2% of purchase price</p>
          <p className="relative shrink-0 text-right w-[145px]">{`UAE market standard for buyer's agent`}</p>
        </div>
      </div>
    </div>
  );
    ...
    <div className="relative shrink-0 w-full" data-name="Frame">
      ...
      <div className="flex flex-row items-center justify-center size-full">
        <div className="content-stretch flex font-['Inter:Regular',sans-serif] font-normal gap-[8px] items-center justify-center leading-[20px] not-italic pb-[2px] px-[8px] relative text-[#0e172b] text-[8px] tracking-[-0.16px] w-full whitespace-pre-wrap">
          ...
          <p className="relative shrink-0 text-right w-[100px]">0.5% of purchase price</p>
          <p className="relative shrink-0 text-right w-[145px]">Estimated (valuation, NOC, legal fees)</p>
        </div>
      </div>
    </div>
  );
...
function Frame4() {
  return (
    <div className="relative shrink-0 w-full" data-name="Frame">
      ...
      <div className="flex flex-row items-center justify-center size-full">
        <div className="content-stretch flex font-['Inter:Regular',sans-serif] font-normal gap-[8px] items-center justify-center leading-[20px] not-italic pb-[2px] px-[8px] relative text-[#0e172b] text-[8px] tracking-[-0.16px] w-full whitespace-pre-wrap">
          <p className="flex-[1_0_0] min-h-px min-w-px relative">Selling Fee at Exit</p>
          <p className="relative shrink-0 text-right w-[100px]">2% of future value</p>
          <p className="relative shrink-0 text-right w-[145px]">{`UAE market standard for seller's agent`}</p>
        </div>
      </div>
    </div>
  );
...
function Frame19() {
  return (
    <div className="content-stretch flex flex-col gap-[8px] items-start relative shrink-0 w-full">
      <p className="font-['Inter:Semi_Bold',sans-serif] font-semibold leading-[16px] not-italic relative shrink-0 text-[#0a1461] text-[14px] tracking-[-0.28px] w-full whitespace-pre-wrap">{`System Constants & Assumptions`}</p>
      <Table />
    </div>
  );
}
