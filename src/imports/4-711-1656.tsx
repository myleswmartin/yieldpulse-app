import svgPaths from "./svg-crd72xyabs";
  ...
  return (
    <div className="bg-white content-stretch flex flex-col items-center justify-center p-[8px] relative rounded-[4px] shrink-0 size-[20px]">
      <div className="flex flex-col font-['Inter:Semi_Bold',sans-serif] font-semibold h-[14px] justify-center leading-[0] not-italic relative shrink-0 text-[#0a1461] text-[8px] text-center tracking-[-0.16px] w-[11px]">
        <p className="leading-[22px] whitespace-pre-wrap">03</p>
      </div>
    </div>
  );
}
    ...
    <div className="bg-[#1f2975] relative rounded-[5px] shrink-0 w-full">
      ...
      <div className="flex flex-row items-center size-full">
        <div className="content-stretch flex gap-[8px] items-center pl-[6px] pr-[8px] py-[6px] relative w-full">
          <Frame19 />
          <p className="font-['Inter:Bold',sans-serif] font-bold leading-[16px] not-italic relative shrink-0 text-[12px] text-white w-[352px] whitespace-pre-wrap">Upfront Capital Requirement</p>
        </div>
      </div>
    </div>
  );
  ...
  return (
    <div className="relative shrink-0 w-full" data-name="Frame">
      ...
      <div className="flex flex-row items-center justify-center size-full">
        <div className="content-stretch flex font-['Inter:Semi_Bold',sans-serif] font-semibold gap-[8px] items-center justify-center leading-[20px] not-italic pb-[2px] px-[8px] relative text-[#1e2875] text-[10px] w-full whitespace-pre-wrap">
          <p className="flex-[1_0_0] min-h-px min-w-px relative">Component</p>
          <p className="relative shrink-0 text-right w-[112px]">Amount</p>
          <p className="relative shrink-0 text-right w-[112px]">% of Price</p>
          <p className="relative shrink-0 text-right w-[112px]">% of Total Investment</p>
        </div>
      </div>
    </div>
  );
    ...
    <div className="relative shrink-0 w-full" data-name="Frame">
      ...
      <div className="flex flex-row items-center justify-center size-full">
        <div className="content-stretch flex font-['Inter:Regular',sans-serif] font-normal gap-[8px] items-center justify-center leading-[20px] not-italic pb-[2px] px-[8px] relative text-[#0e172b] text-[8px] tracking-[-0.16px] w-full whitespace-pre-wrap">
          <p className="flex-[1_0_0] min-h-px min-w-px relative">Down Payment (Equity)</p>
          <p className="relative shrink-0 text-right w-[142px]">AED 360,000</p>
          <p className="relative shrink-0 text-right w-[107px]">30.0%</p>
          <p className="flex-[1_0_0] min-h-px min-w-px relative text-right">82.4%</p>
        </div>
      </div>
    </div>
  );
...
function Frame2() {
  return (
    <div className="relative shrink-0 w-full" data-name="Frame">
      ...
      <div className="flex flex-row items-center justify-center size-full">
        <div className="content-stretch flex font-['Inter:Regular',sans-serif] font-normal gap-[8px] items-center justify-center leading-[20px] not-italic pb-[2px] px-[8px] relative text-[#0e172b] text-[8px] tracking-[-0.16px] w-full whitespace-pre-wrap">
          <p className="flex-[1_0_0] min-h-px min-w-px relative">DLD Registration Fee</p>
          <p className="relative shrink-0 text-right w-[142px]">AED 48,000</p>
          <p className="relative shrink-0 text-right w-[107px]">4.00%</p>
          <p className="flex-[1_0_0] min-h-px min-w-px relative text-right">11.0%</p>
        </div>
      </div>
    </div>
  );
    ...
    <div className="relative shrink-0 w-full" data-name="Frame">
      <div className="flex flex-row items-center justify-center size-full">
        <div className="content-stretch flex font-['Inter:Regular',sans-serif] font-normal gap-[8px] items-center justify-center leading-[20px] not-italic px-[8px] relative text-[#0e172b] text-[8px] tracking-[-0.16px] w-full whitespace-pre-wrap">
          <p className="flex-[1_0_0] min-h-px min-w-px relative">Agent Commission</p>
          <p className="relative shrink-0 text-right w-[142px]">AED 24,000</p>
          <p className="relative shrink-0 text-right w-[107px]">2.00%</p>
          <p className="flex-[1_0_0] min-h-px min-w-px relative text-right">5.49%</p>
        </div>
      </div>
    </div>
  );
...
function Frame4() {
  return (
    <div className="relative shrink-0 w-full" data-name="Frame">
      <div className="flex flex-row items-center justify-center size-full">
        <div className="content-stretch flex font-['Inter:Regular',sans-serif] font-normal gap-[8px] items-center justify-center leading-[20px] not-italic px-[8px] relative text-[#0e172b] text-[8px] tracking-[-0.16px] w-full whitespace-pre-wrap">
          <p className="flex-[1_0_0] min-h-px min-w-px relative">Other Closing Costs</p>
          <p className="relative shrink-0 text-right w-[142px]">AED 5,000</p>
          <p className="relative shrink-0 text-right w-[107px]">0.50%</p>
          <p className="flex-[1_0_0] min-h-px min-w-px relative text-right">1.14%</p>
        </div>
      </div>
    </div>
  );
...
function Frame5() {
  return (
    <div className="relative shrink-0 w-full" data-name="Frame">
      <div className="flex flex-row items-center justify-center size-full">
        <div className="content-stretch flex font-['Inter:Semi_Bold',sans-serif] font-semibold gap-[8px] items-center justify-center leading-[20px] not-italic px-[8px] relative text-[#1e2875] text-[8px] w-full whitespace-pre-wrap">
          <p className="flex-[1_0_0] min-h-px min-w-px relative">Total Initial Investment</p>
          <p className="relative shrink-0 w-[133px]">AED 437,000</p>
          <p className="relative shrink-0 text-right w-[136px]">100.00%</p>
        </div>
      </div>
    </div>
  );
...
function Frame22() {
  return (
    <div className="content-stretch flex flex-col gap-[12px] items-start relative shrink-0 w-full">
      <p className="font-['Inter:Regular',sans-serif] font-normal leading-[20px] not-italic opacity-50 relative shrink-0 text-[#0e172b] text-[10px] tracking-[-0.2px] w-full whitespace-pre-wrap">Total cash required to complete the purchase:</p>
      <Table />
    </div>
  );
}
      ...
      <div className="flex flex-col justify-center overflow-clip rounded-[inherit] size-full">
        <div className="content-stretch flex flex-col gap-[2px] items-start justify-center not-italic px-[12px] py-[8px] relative w-full whitespace-pre-wrap">
          ...
          <p className="font-['Inter:Regular',sans-serif] font-normal leading-[0] relative shrink-0 text-[0px] text-[8px] text-[rgba(14,23,43,0.5)] tracking-[-0.16px] w-full">
            <span className="leading-[14px]">{`Your down payment of `}</span>
            <span className="font-['Inter:Medium',sans-serif] font-medium leading-[14px] text-[#0e172b]">AED 360,000</span>
            <span className="leading-[14px]">{` represents `}</span>
            <span className="font-['Inter:Medium',sans-serif] font-medium leading-[14px] text-[#0e172b]">30.0%</span>
            <span className="leading-[14px]">{` of purchase price and becomes immediate equity. Transaction fees (DLD, agent, closing costs) total `}</span>
            <span className="font-['Inter:Medium',sans-serif] font-medium leading-[14px] text-[#0e172b]">{`AED 77,000, `}</span>
            <span className="leading-[14px]">{`representing `}</span>
            <span className="font-['Inter:Medium',sans-serif] font-medium leading-[14px] text-[#0e172b]">17.6%</span>
            <span className="leading-[14px]">{` of your total investment. These fees are non-recoverable acquisition costs that increase your effective cost basis.`}</span>
          </p>
        </div>
      </div>
      <div aria-hidden="true" className="absolute border-[#eef0f2] border-[0.8px] border-solid inset-0 pointer-events-none rounded-[8px]" />
