import svgPaths from "./svg-fejnn58qfv";
...
function Text() {
  return (
    <div className="content-stretch flex flex-col gap-[8px] items-center not-italic relative shrink-0 text-white w-full whitespace-pre-wrap" data-name="Text">
      <p className="font-['Inter:Semi_Bold',sans-serif] font-semibold leading-[36px] relative shrink-0 text-[20px] tracking-[-0.4px] w-full">Property Investment Comparison Report</p>
      <p className="font-['Inter:Regular',sans-serif] font-normal leading-[22px] relative shrink-0 text-[12px] tracking-[-0.48px] w-full">Side by side analysis of property investment performance, cash flow, and risk profiles</p>
    </div>
  );
}
  ...
  return (
    <div className="flex-[1_0_0] min-h-px min-w-px relative" data-name="Text">
      <div className="flex flex-col items-center size-full">
        <div className="content-stretch flex flex-col gap-[8px] items-center not-italic px-[8px] relative text-[#0e172b] w-full whitespace-pre-wrap">
          <p className="font-['Inter:Semi_Bold',sans-serif] font-semibold leading-[28px] relative shrink-0 text-[16px] w-full">Report Overview</p>
          <p className="font-['Inter:Regular',sans-serif] font-normal h-[56px] leading-[20px] relative shrink-0 text-[10px] w-full">This report compares selected properties across purchase price, rental income, yield, cash flow, and long-term returns.</p>
        </div>
      </div>
    </div>
  );
...
function Frame2() {
  return (
    <div className="content-stretch flex gap-[8px] items-center relative shrink-0 w-full">
      <Frame1 />
      <p className="font-['Inter:Regular',sans-serif] font-normal leading-[16px] not-italic relative shrink-0 text-[#0e172b] text-[10px]">test 123 (YP-002374)</p>
    </div>
  );
}
...
function Frame6() {
  return (
    <div className="content-stretch flex gap-[8px] items-center relative shrink-0 w-full">
      <Frame7 />
      <p className="font-['Inter:Regular',sans-serif] font-normal leading-[16px] not-italic relative shrink-0 text-[#0e172b] text-[10px]">Unnamed Property (YP-002609)</p>
    </div>
  );
}
...
function Text2() {
  return (
    <div className="flex-[1_0_0] min-h-px min-w-px relative" data-name="Text">
      <div className="flex flex-col items-center size-full">
        <div className="content-stretch flex flex-col gap-[8px] items-center px-[8px] relative w-full">
          <p className="font-['Inter:Semi_Bold',sans-serif] font-semibold leading-[28px] not-italic relative shrink-0 text-[#0e172b] text-[16px] w-full whitespace-pre-wrap">Properties Compared</p>
          <Frame5 />
        </div>
      </div>
    </div>
...
function Frame() {
  return (
    <div className="content-stretch flex gap-[24px] items-center py-[8px] relative shrink-0 w-full">
      <Text1 />
      <Text2 />
    </div>
  );
...
function Text3() {
  return (
    <div className="content-stretch flex flex-col gap-[8px] items-center px-[8px] relative shrink-0 w-[245.5px]" data-name="Text">
      <Frame10 />
      <Frame13 />
      <Frame15 />
    </div>
