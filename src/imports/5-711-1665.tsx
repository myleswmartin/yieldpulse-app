import svgPaths from "./svg-0t6deb36ol";
  ...
  return (
    <div className="bg-white content-stretch flex flex-col items-center justify-center p-[8px] relative rounded-[4px] shrink-0 size-[20px]">
      <div className="flex flex-col font-['Inter:Semi_Bold',sans-serif] font-semibold h-[14px] justify-center leading-[0] not-italic relative shrink-0 text-[#0a1461] text-[8px] text-center tracking-[-0.16px] w-[11px]">
        <p className="leading-[22px] whitespace-pre-wrap">04</p>
      </div>
    </div>
  );
}
    ...
    <div className="bg-[#1f2975] relative rounded-[5px] shrink-0 w-full">
      ...
      <div className="flex flex-row items-center size-full">
        <div className="content-stretch flex gap-[8px] items-center pl-[6px] pr-[8px] py-[6px] relative w-full">
          <Frame33 />
          <p className="font-['Inter:Bold',sans-serif] font-bold leading-[16px] not-italic relative shrink-0 text-[12px] text-white w-[352px] whitespace-pre-wrap">Mortgage Breakdown</p>
        </div>
      </div>
    </div>
  );
...
function Frame15() {
  return (
    <div className="content-stretch flex flex-[1_0_0] gap-[8px] h-[20px] items-center leading-[24px] min-h-px min-w-px not-italic relative text-[#0a1461] text-[10px] tracking-[-0.4px]">
      <p className="flex-[1_0_0] font-['Inter:Regular',sans-serif] font-normal min-h-px min-w-px relative whitespace-pre-wrap">Loan Amount:</p>
      <p className="font-['Inter:Bold',sans-serif] font-bold relative shrink-0">AED 840,000</p>
    </div>
  );
}
...
function Frame17() {
  return (
    <div className="content-stretch flex flex-[1_0_0] gap-[8px] h-[20px] items-center leading-[24px] min-h-px min-w-px not-italic relative text-[#0a1461] text-[10px] tracking-[-0.4px]">
      <p className="flex-[1_0_0] font-['Inter:Regular',sans-serif] font-normal min-h-px min-w-px relative whitespace-pre-wrap">Loan-to-Value (LTV):</p>
      <p className="font-['Inter:Bold',sans-serif] font-bold relative shrink-0">70.0%</p>
    </div>
  );
}
...
function Frame18() {
  return (
    <div className="content-stretch flex flex-[1_0_0] gap-[8px] h-[20px] items-center leading-[24px] min-h-px min-w-px not-italic relative text-[#0a1461] text-[10px] tracking-[-0.4px]">
      ...
      <p className="font-['Inter:Bold',sans-serif] font-bold relative shrink-0">5.00% p.a.</p>
    </div>
  );
}
...
function Frame26() {
  return (
    <div className="content-stretch flex flex-[1_0_0] gap-[8px] h-[20px] items-center leading-[24px] min-h-px min-w-px not-italic relative text-[#0a1461] text-[10px] tracking-[-0.4px]">
      <p className="flex-[1_0_0] font-['Inter:Regular',sans-serif] font-normal min-h-px min-w-px relative whitespace-pre-wrap">Monthly Payment:</p>
      <p className="font-['Inter:Bold',sans-serif] font-bold relative shrink-0">AED 4,911</p>
    </div>
  );
}
...
function Frame28() {
  return (
    <div className="content-stretch flex flex-[1_0_0] gap-[8px] h-[20px] items-center leading-[24px] min-h-px min-w-px not-italic relative text-[#0a1461] text-[10px] tracking-[-0.4px]">
      <p className="flex-[1_0_0] font-['Inter:Regular',sans-serif] font-normal min-h-px min-w-px relative whitespace-pre-wrap">Annual Payment:</p>
      <p className="font-['Inter:Bold',sans-serif] font-bold relative shrink-0">AED 58,927</p>
    </div>
  );
}
...
function Frame30() {
  return (
    <div className="content-stretch flex flex-[1_0_0] gap-[8px] h-[20px] items-center leading-[24px] min-h-px min-w-px not-italic relative text-[#0a1461] text-[10px] tracking-[-0.4px]">
      <p className="flex-[1_0_0] font-['Inter:Regular',sans-serif] font-normal min-h-px min-w-px relative whitespace-pre-wrap">First Year Interest:</p>
      <p className="font-['Inter:Bold',sans-serif] font-bold relative shrink-0">AED 42,000</p>
    </div>
  );
}
...
function Frame32() {
  return (
    <div className="content-stretch flex flex-[1_0_0] gap-[8px] h-[20px] items-center leading-[24px] min-h-px min-w-px not-italic relative text-[#0a1461] text-[10px] tracking-[-0.4px]">
      <p className="flex-[1_0_0] font-['Inter:Regular',sans-serif] font-normal min-h-px min-w-px relative whitespace-pre-wrap">First Year Principal</p>
      <p className="font-['Inter:Bold',sans-serif] font-bold relative shrink-0">AED 16,927</p>
    </div>
  );
}
...
function Frame36() {
  return (
    <div className="relative shrink-0 w-full">
      <div className="content-stretch flex flex-col gap-[8px] items-start not-italic px-[4px] relative w-full whitespace-pre-wrap">
        <p className="font-['Inter:Semi_Bold',sans-serif] font-semibold leading-[16px] relative shrink-0 text-[#0a1461] text-[14px] tracking-[-0.28px] w-full">First Year Amortization</p>
        <p className="font-['Inter:Regular',sans-serif] font-normal leading-[14px] relative shrink-0 text-[10px] text-[rgba(14,23,43,0.5)] tracking-[-0.2px] w-full">In Year 1, 71.3% of your mortgage payment goes to interest (AED 42,000), with only 28.7% reducing principal (AED 16,927). Over the full 25-year term, you will pay AED 633,167 in total interest.</p>
      </div>
    </div>
  );
}
    ...
    <div className="bg-[#f8fafc] relative rounded-[8px] shrink-0 w-full">
      <div className="flex flex-col justify-center overflow-clip rounded-[inherit] size-full">
        <div className="content-stretch flex flex-col gap-[2px] items-start justify-center not-italic px-[12px] py-[8px] relative w-full whitespace-pre-wrap">
          ...
          <p className="font-['Inter:Regular',sans-serif] font-normal leading-[14px] relative shrink-0 text-[8px] text-[rgba(14,23,43,0.5)] tracking-[-0.16px] w-full">Your loan of AED 840,000 (70.0% LTV) requires AED 4,911 monthly payments. Early years are interest-heavy: AED 42,000 interest versus AED 16,927 principal in Year 1. True property cost including interest is AED 1,833,167.</p>
        </div>
      </div>
