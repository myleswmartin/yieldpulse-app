import svgPaths from "@/imports/svg-thqyw3meum";
...
export default function PremiumReportPage2PropertyDetails() {
  return (
    <div className="bg-white relative size-full" data-name="Premium Report Page 2 - Property Details">
      <Frame9 />
    </div>
  );
}
